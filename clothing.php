...
if (!empty($category_ids)) {
    if ($selected_category) {
        ...
        // Get products from all clothing categories
...
<div class="container py-5">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <a href="clothing.php?category=<?= $category['id'] ?>" class="btn btn-outline-primary w-100">
    ...
    <div class="row">
        <?php if (empty($products)): ?>
            <div class="col-12">
                <div class="alert alert-info">No clothing products found.</div>
            </div>
        <?php else: ?>
